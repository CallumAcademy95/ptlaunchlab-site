...
const staticPages: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE}/enrol`,                               priority: 0.9,  changeFrequency: "monthly" },
  { url: `${BASE}/book-call`,                           priority: 0.8,  changeFrequency: "monthly" },
  { url: `${BASE}/about`,                               priority: 0.7,  changeFrequency: "monthly" },
  { url: `${BASE}/quiz`,                                priority: 0.7,  changeFrequency: "monthly" },
  { url: `${BASE}/contact`,                             priority: 0.6,  changeFrequency: "monthly" },
  { url: `${BASE}/blog`,                                priority: 0.6,  changeFrequency: "weekly"  },
  { url: `${BASE}/personal-trainer-salary-uk`,          priority: 0.7,  changeFrequency: "monthly" },
  { url: `${BASE}/personal-trainer-mentorship-uk`,      priority: 0.7,  changeFrequency: "monthly" },
  { url: `${BASE}/personal-trainer-course-near-me`,     priority: 0.7,  changeFrequency: "monthly" },
  { url: `${BASE}/self-employed-personal-trainer-uk`,   priority: 0.6,  changeFrequency: "monthly" },
];
