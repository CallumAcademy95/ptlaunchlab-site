...
export async function generateMetadata({ params }: { params: Promise<{ location: string }> }) {
  ...
  return {
    ...
    description: `Become a qualified personal trainer from ${loc.name}. NCFE Level 3, 100% online, with business mentorship built in. Qualify in 8–16 weeks and go self-employed.`,
