...
export async function generateMetadata({ params }: { params: Promise<{ location: string }> }) {
  ...
  return {
    ...
    description: `Become a personal trainer online from ${loc.name}. Study 100% online, gain your NCFE Level 3, and get business mentorship to launch your PT career. Qualify in 8–16 weeks.`,
