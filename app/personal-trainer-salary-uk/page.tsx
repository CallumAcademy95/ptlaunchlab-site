          ...
          <div className="max-w-3xl mx-auto space-y-14 md:space-y-20">
            ...
            <section>
              ...
              <div className="space-y-5 text-soft/80 text-base leading-relaxed">
                ...
                <p>The structural problem with chain employment: you&apos;re allowed to pick up clients only on the gym floor itself. Mac again: &quot;The thing was, the gym is where most PTs pick up their first clients. If you&apos;re not there when someone walks through the door, you&apos;re not picking them up as a client.&quot; The realistic first-year figure for a PureGym self-employed PT is £20k–£25k of actual take-home — rent and tax come out, and you&apos;re paying for your own pension, insurance, and any sick days.</p>
            ...
            <section>
              ...
              <ol className="space-y-5">
                {[
                  ...
                  { title: "Gym-floor-only thinking", body: "Mac on EP8: \"The gym is where most PTs pick up their first clients.\" If you don't post, don't email, don't run group sessions, you're capped at the foot traffic in your one gym." },
