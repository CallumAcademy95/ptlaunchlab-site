      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="bg-card rounded-2xl p-6 md:p-8 text-left flex flex-col border border-white/[0.08] shadow-2xl shadow-black/20">
            ...
            <p className="text-soft/65 text-[15px] leading-relaxed mb-7">
              One payment, and immediate access to your tutor, the NCFE qualification, the £500 business mentorship community, and the guaranteed gym interview you get on qualifying. No instalments, no additional fees.
            </p>
            <ul className="space-y-3 mb-8 flex-1">
              {[
                "One payment, fully covered",
                "Full course access from day one",
                "Personal tutor, £500 mentorship community, guaranteed gym interview",
