    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#061F36] border-b border-[#3B82F6]/20">
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-[72px]">
        ...
        <div className="hidden lg:flex items-center gap-3">
          <a
            href="/book-call"
            className="px-5 py-2.5 rounded-full border border-[#F5C518] text-[#F5C518] text-sm font-semibold hover:bg-[#F5C518] hover:text-[#072B4A] transition-all"
          >
            Book a Free Call
          </a>
          <a
      ...
      {/* Mobile menu */}
      {open && (
        <div className="lg:hidden bg-[#0D3559] border-t border-[#3B82F6]/20 px-6 py-6 flex flex-col gap-4">
          {links.map((l) => (
