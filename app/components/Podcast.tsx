          ...
          <div>
            ...
            <ul className="space-y-3 mb-10">
              {[
                ...
                <li key={item} className="flex items-start gap-3 text-[#8CA3BF] text-[15px]">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full border-2 border-[#F5C518] text-[#F5C518] font-bold text-sm hover:bg-[#F5C518] hover:text-[#072B4A] transition-all"
            >
              Watch on YouTube →
            </a>
          </div>
