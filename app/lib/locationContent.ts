...
const locationInsights: Record<string, LocationContent> = {
  london: {
    marketContext: "London has the largest concentration of fitness facilities in the UK, with over 1,500 gyms and studios across its 33 boroughs. The market is competitive at entry level, particularly in affluent areas like Chelsea, Canary Wharf, and Richmond, where clients routinely pay £60–£100 per session.",
    opportunity: "London's fitness market is large and varied: boutique studios, corporate wellness programmes and independent gym operators all sit alongside the national chains. With the right qualification and business foundation, London gives you the fastest route from newly qualified to fully booked.",
  ...
  manchester: {
    ...
    opportunity: "Manchester's fitness scene is expanding. The city's large student population, young professional demographic, and strong sporting culture (home to two Premier League clubs) create a PT client base that's both broad and motivated.",
  ...
  liverpool: {
    ...
    whyOnline: "Studying online from Liverpool means you can qualify while working around Merseyside's shift-based economy, whether you're in hospitality, retail, or already working in a gym. You complete your qualification on your schedule, then start looking for work with the qualification already in hand.",
  ...
  bristol: {
    ...
    marketSize: "Bristol and the surrounding area support over 200 fitness facilities. The city has a thriving mix of national operators and independent gyms. NCFE Level 3 is Ofqual regulated under reference 603/4388/6 and CIMSPA recognised, which is what employers ask to see.",
  },
  newcastle: {
    ...
    marketSize: "Tyne & Wear supports over 150 gyms and fitness facilities across Newcastle, Gateshead, Sunderland, and surrounding areas. NCFE Level 3 is Ofqual regulated under reference 603/4388/6 and CIMSPA recognised, which is what employers ask to see.",
  },
  edinburgh: {
  ...
  leicester: {
    ...
    marketSize: "Leicester and Leicestershire support over 150 gyms and fitness facilities. The city has national operator presence alongside a strong independent gym sector. NCFE Level 3 is Ofqual regulated under reference 603/4388/6 and CIMSPA recognised, which is what employers ask to see.",
  },
  brighton: {
    ...
    marketSize: "Brighton and Hove support over 120 gyms and fitness facilities, with a strong mix of national operators and premium independent studios. NCFE Level 3 is Ofqual regulated under reference 603/4388/6 and CIMSPA recognised, which is what employers ask to see.",
  },
  "southampton": {
    ...
    marketSize: "Southampton and the surrounding Hampshire area support over 150 gyms and fitness facilities. NCFE Level 3 is Ofqual regulated under reference 603/4388/6 and CIMSPA recognised, which is what employers ask to see.",
  },
  hull: {
...
const regionInsights: Record<string, LocationContent> = {
  "West Yorkshire": {
    ...
    opportunity: "West Yorkshire's fitness market is growing alongside the region's wider economic development. Leeds, Bradford, Huddersfield and Wakefield all have active gym sectors, and PT Launch Lab's own gym partnerships are concentrated here.",
  ...
  "South Yorkshire": {
    ...
    marketSize: "South Yorkshire supports over 200 gyms and fitness facilities. Major national operators have strong regional presence, alongside independent gyms across Sheffield and the surrounding area. NCFE Level 3 is Ofqual regulated under reference 603/4388/6 and CIMSPA recognised, which is what employers ask to see.",
  },
  "North Yorkshire": {
  ...
  "East Yorkshire": {
    ...
    marketSize: "East Yorkshire supports gyms and fitness facilities across Hull, Beverley, Bridlington, and surrounding towns, with a mix of national operators and independent gyms. NCFE Level 3 is Ofqual regulated under reference 603/4388/6 and CIMSPA recognised, which is what employers ask to see.",
  },
  "Greater Manchester": {
  ...
  "Merseyside": {
    ...
    marketSize: "Merseyside supports over 200 gyms and fitness facilities across its five local authority areas. NCFE Level 3 is Ofqual regulated under reference 603/4388/6 and CIMSPA recognised, which is what employers ask to see.",
  },
  "West Midlands": {
  ...
  "London": {
    marketContext: "London has the largest concentration of fitness facilities in the UK, with over 1,500 gyms and studios across its 33 boroughs. The capital's fitness market operates at the premium end of national earning potential.",
    opportunity: "London's fitness market is large and varied. Boutique studios, corporate wellness programmes and independent gym operators all sit alongside the national chains. With the right qualification and business foundation, London gives you the fastest route from newly qualified to fully booked.",
  ...
  "South East England": {
    ...
    marketSize: "The South East supports hundreds of gyms and fitness facilities across Surrey, Kent, Sussex, Hampshire, and Berkshire, including both national operators and premium independent clubs. NCFE Level 3 is Ofqual regulated under reference 603/4388/6 and CIMSPA recognised, which is what employers ask to see.",
  },
  "South West England": {
    ...
    marketSize: "The South West supports hundreds of gyms and fitness facilities across its major cities and market towns. NCFE Level 3 is Ofqual regulated under reference 603/4388/6 and CIMSPA recognised, which is what employers ask to see.",
  },
  "Scotland": {
  ...
  "Wales": {
    ...
    marketSize: "Wales supports over 250 gyms and fitness facilities across its urban areas, including both national operators and independent gyms. NCFE Level 3 is Ofqual regulated under reference 603/4388/6 and CIMSPA recognised, which is what employers ask to see.",
  },
  "Northern Ireland": {
