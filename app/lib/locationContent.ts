...
const locationInsights: Record<string, LocationContent> = {
  london: {
    ...
    marketSize: "London accounts for roughly 25% of UK gym memberships. Major operators including PureGym, Virgin Active, David Lloyd, Nuffield Health, and Equinox all have significant London presence, alongside hundreds of independent gyms and studios.",
  },
  manchester: {
