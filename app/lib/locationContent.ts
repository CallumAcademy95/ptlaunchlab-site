...
const locationInsights: Record<string, LocationContent> = {
  london: {
    ...
    marketSize: "London accounts for roughly 25% of UK gym memberships. Major operators including PureGym, Virgin Active, David Lloyd, Nuffield Health, and Equinox all have significant London presence — each actively hiring NCFE and CIMSPA-recognised PTs.",
  },
  manchester: {
    ...
    marketSize: "Greater Manchester has one of the highest gym membership rates in the UK. PureGym, JD Gyms, Nuffield Health, The Gym Group and dozens of independent operators all regularly recruit NCFE-qualified PTs across the region.",
  },
  birmingham: {
    ...
    marketSize: "Birmingham and the West Midlands region supports a significant gym economy with major operators including PureGym, The Gym Group, Anytime Fitness, and David Lloyd all operating multiple sites and regularly looking for qualified PT staff.",
  },
  leeds: {
    ...
    marketSize: "Leeds supports over 200 gyms and fitness facilities across the city and its suburbs. The city is home to multiple PureGym, The Gym Group, Nuffield Health, and independent operator sites — all of which recognise and regularly hire NCFE-qualified PTs.",
  },
  liverpool: {
  ...
  sheffield: {
    ...
    marketSize: "Sheffield and South Yorkshire support over 150 gyms and fitness facilities. The city has strong PureGym, The Gym Group, and Nuffield Health presence alongside a thriving independent gym sector that values NCFE-qualified, CIMSPA-recognised trainers.",
  },
  bristol: {
  ...
  edinburgh: {
    ...
    marketSize: "Edinburgh supports over 150 gyms and fitness facilities, with a strong presence of premium operators including David Lloyd, Virgin Active, and Nuffield Health alongside a growing boutique studio sector — all of which recognise NCFE Level 3.",
  },
  glasgow: {
    ...
    marketSize: "Greater Glasgow supports over 300 gyms and fitness facilities. Major operators including PureGym, The Gym Group, Nuffield Health, and David Lloyd all operate multiple Glasgow sites and regularly hire NCFE-qualified, CIMSPA-recognised PTs.",
  },
  cardiff: {
    ...
    whyOnline: "Studying online from Cardiff means qualifying around your existing commitments — whether you're studying, working, or already gym-based in Wales. The qualification is fully UK-wide and recognised by every major operator in Cardiff and beyond.",
...
const regionInsights: Record<string, LocationContent> = {
  ...
  "Greater Manchester": {
    ...
    marketSize: "Greater Manchester supports over 400 gyms and fitness facilities. Every major national operator has significant Manchester presence, and the independent sector is thriving — all of which recognise NCFE Level 3 and CIMSPA accreditation.",
  },
  "Merseyside": {
  ...
  "West Midlands": {
    ...
    marketSize: "The West Midlands supports over 400 gyms and fitness facilities across its urban centres. Every major national operator has significant regional presence, and the independent sector employs hundreds of NCFE-qualified PTs.",
  },
  "East Midlands": {
  ...
  "Scotland": {
    ...
    marketSize: "Scotland supports over 600 gyms and fitness facilities across its populated areas. Major national operators including PureGym, The Gym Group, Nuffield Health, and David Lloyd all have Scottish presence and regularly hire NCFE-qualified, CIMSPA-recognised PTs.",
  },
  "Wales": {
  ...
  "Northern Ireland": {
    ...
    whyOnline: "Studying online from Northern Ireland means accessing a UK-wide qualification from home. Your NCFE Level 3 is fully recognised across Northern Ireland and the Republic, and PT Launch Lab's support covers every region of the UK.",
...
const genericContent: LocationContent = {
  marketContext: "The UK fitness industry employs over 100,000 personal trainers and continues to grow year on year. Demand for qualified, NCFE-accredited PTs remains strong across the country — from major cities to market towns — as gym membership rates reach record highs.",
  ...
  marketSize: "The UK gym market is worth over £5 billion and supports thousands of facilities nationwide. Every major gym operator — PureGym, The Gym Group, David Lloyd, Nuffield Health, JD Gyms — recognises NCFE Level 3 and CIMSPA accreditation as the standard qualification for PT employment.",
};
