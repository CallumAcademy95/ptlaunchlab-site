...
export const metadata = {
  ...
  description: "Looking for the best UK PT course? PT Launch Lab bundles NCFE Level 3 (the qualification UK gym managers ask for by name), our £500 business mentorship community, a personal tutor, and a guaranteed gym interview — all for £1,599. Most UK academies sell mentorship separately for £500–£3,000.",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#F5C518]/40 bg-white/10 backdrop-blur-sm mb-6">
                  <span className="text-[#F5C518] text-xs font-semibold tracking-widest uppercase">Best PT Course UK</span>
                </div>
                ...
                <p className="text-base text-blue-100/80 leading-relaxed mb-8">
                  We fix that. NCFE Level 3 — the qualification UK gym managers ask for by name — plus our £500 business mentorship community, a personal tutor, and a guaranteed gym interview, all bundled into the £1,599 fee. Most UK academies charge for mentorship separately, or skip it entirely. We don&apos;t. Qualify in 12–16 weeks and come out ready to earn.
                </p>
