...
export const metadata = {
  ...
  description: "Looking for the best UK PT course? PT Launch Lab bundles NCFE Level 3 (the qualification UK gym managers ask for by name), our £500 business mentorship community, a personal tutor, and a guaranteed gym interview — all for £1,599. Here it is in the fee rather than sold on afterwards.",
