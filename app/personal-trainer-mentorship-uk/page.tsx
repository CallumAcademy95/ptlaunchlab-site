...
export const metadata = {
  title: "Personal Trainer Mentorship UK | PT Launch Lab",
  description: "PT Launch Lab offers real personal trainer mentorship as standard — not a helpdesk. Direct access to experienced PTs who've built careers, hired staff and run gyms. Mentorship from day one.",
};
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white leading-[1.1] mb-6">
                  Real mentorship.<br />
                  <span className="text-[#F5C518]">Not a helpdesk.</span>
                </h1>
                <p className="text-lg md:text-xl text-white font-semibold leading-snug mb-4">
                  Every PT Launch Lab student gets direct access to mentors who've built real careers in fitness — not tutors who've only ever taught.
                </p>
                <p className="text-base text-blue-100/80 leading-relaxed mb-8">
                  From your first lesson through to your first paying client, we're with you every step. That's not a marketing line — it's how we built this course.
                </p>
                ...
                <div className="flex flex-wrap gap-3 text-blue-200/70 text-xs">
                  ...
                  <span>Mentorship as Standard</span><span className="opacity-40">·</span>
