          ...
          <div className="max-w-3xl mx-auto">
            ...
            <ol className="space-y-6">
              {[
                ...
                { title: "Real gym connections and a guaranteed interview", body: "This is where most courses fail loudly. They sell the qualification, then wave you off into a market with 69,000 registered PTs (the 2022 figure Ryan referenced on the \"Is It Still Worth It?\" episode). At PT Launch Lab you get a guaranteed warm-introduction interview when you qualify — we vouch for you to gym managers we already know. Most providers can't offer that because they don't run gyms." },
