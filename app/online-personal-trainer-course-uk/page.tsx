        ...
        <section id="recognition" className="bg-surface py-14 md:py-20 px-6 border-y border-blue/15">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-5 text-soft/80 text-base leading-relaxed">
              ...
              <p>
                <strong className="text-gold">CIMSPA</strong> is the industry body — it's the chartered institute that maintains the public register of PTs in the UK. A CIMSPA-recognised course meets the employer standard. Commercial gyms generally want to see CIMSPA on your paperwork.
              </p>
              <p>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {[
                ...
                { title: "Online wins on flexibility", body: "Almost everyone enrolling on a PT course is changing career while still holding down their current job. You can't take three weeks off work to sit in a classroom. Online lets you study at 6am or 10pm. For most career changers that's the realistic route." },
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <ol className="space-y-6">
              {[
                ...
                { title: "Mentorship after qualification", body: "Day one of your career is where the hard part starts. The hardest 90 days are the next ones. We bundle the £500 Skool business mentorship community into our £1,599 fee at no extra cost — Miles, Ryan and Callum all hang out in there, and the gym owners running the network have hired 500+ PTs between them. If your course says \"your support ends when you pass,\" that's the wrong course." },
                { title: "Real gym connections and a guaranteed interview", body: "This is the part that decides whether the qualification pays for itself. They sell the qualification, then wave you off into a market with 69,000 registered PTs (the 2022 figure Ryan referenced on the \"Is It Still Worth It?\" episode). At PT Launch Lab you get a guaranteed warm-introduction interview when you qualify — we vouch for you to gym managers we already know. We can offer that because we run gyms." },
