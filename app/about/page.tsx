      ...
      <main className="pt-[72px]">
            ...
            <div className="space-y-6 max-w-3xl mx-auto">
              {timeline.map((item, i) => (
                <div key={i} className="flex gap-6 items-start">
                  ...
                  <div className="bg-[#0D3559] border border-[#3B82F6]/25 rounded-2xl p-6 flex-1">
        ...
        <section className="bg-[#072B4A] py-24 px-6">
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-[#0D3559] border border-[#3B82F6]/25 rounded-2xl p-8 text-center">
              ...
              <div className="flex flex-col gap-3">
                <a href="https://www.youtube.com/@ptlaunchlab" target="_blank" rel="noopener noreferrer"
                  className="px-5 py-2.5 rounded-full bg-[#F5C518] text-[#072B4A] font-bold text-sm hover:brightness-110 transition-all">YouTube</a>
