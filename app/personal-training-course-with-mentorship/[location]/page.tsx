...
export async function generateMetadata({ params }: { params: Promise<{ location: string }> }) {
  ...
  return {
    ...
    description: `Find a personal training course with mentorship near ${loc.name}. PT Launch Lab combines NCFE Level 3 qualification with real business mentorship. Qualify in 8–16 weeks.`,
...
export default async function LocationPage({ params }: { params: Promise<{ location: string }> }) {
  ...
  return (
    <>
      <Nav />
      <main>
        <LocationHero location={loc.name} headline="Personal Training Course With Mentorship in {location}.|Qualification + business mentorship combined." />
