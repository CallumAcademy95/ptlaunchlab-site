---
title: SMS and WhatsApp messages
type: email
channel: Text & WhatsApp
when_to_use: Someone gave you their number, or replied and went quiet
order: 70
---
...
**Someone asked at reception and left**
```
Hi [Name], you asked about the Personal Training academy earlier. Here's
everything: [ACADEMY LINK]

Happy to go through it next time you're in.
```
...
**Say who you are.** A text from an unknown number about a career gets read as a scam. First name and gym name, first line.
